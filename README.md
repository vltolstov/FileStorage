...
Одностраничный фронт реализован на React. Взят и немного изменен https://github.com/zhukovsd/cloud-storage-frontend/tree/master/dist.

Допустимый размер для загрузки файлов 10Мб, для аталогов 50мб.
...
Сконфигурировать docker-compose.yaml в корне проекта. Сконфигурировать application.properties под прод.
